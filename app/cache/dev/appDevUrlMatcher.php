    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin_')) {
            ...
            if ($pathinfo === '/admin_index') {
                return array (  '_controller' => 'AppBundle\\Controller\\PagineController::admin_indexAction',  '_route' => 'admin_index',);
            }

            // admin_operatori
            if ($pathinfo === '/admin_operatori') {
                return array (  '_controller' => 'AppBundle\\Controller\\PagineController::admin_operatoriAction',  '_route' => 'admin_operatori',);
            }

            // admin_campagne
            if ($pathinfo === '/admin_campagne') {
                return array (  '_controller' => 'AppBundle\\Controller\\PagineController::admin_campagneAction',  '_route' => 'admin_campagne',);
            }

            // admin_report
            if ($pathinfo === '/admin_report') {
                return array (  '_controller' => 'AppBundle\\Controller\\PagineController::admin_reportAction',  '_route' => 'admin_report',);
            }

        }

        if (0 === strpos($pathinfo, '/operatore_')) {
            // operatore_index
            if ($pathinfo === '/operatore_index') {
                return array (  '_controller' => 'AppBundle\\Controller\\PagineController::operatore_indexAction',  '_route' => 'operatore_index',);
            }

            if (0 === strpos($pathinfo, '/operatore_campagne_')) {
                // operatore_campagne_attive
                if ($pathinfo === '/operatore_campagne_attive') {
                    return array (  '_controller' => 'AppBundle\\Controller\\PagineController::operatore_campagne_attiveAction',  '_route' => 'operatore_campagne_attive',);
                }

                // operatore_campagne_passate
                if ($pathinfo === '/operatore_campagne_passate') {
                    return array (  '_controller' => 'AppBundle\\Controller\\PagineController::operatore_campagne_passateAction',  '_route' => 'operatore_campagne_passate',);
                }
